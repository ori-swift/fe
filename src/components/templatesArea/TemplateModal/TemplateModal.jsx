...
const TemplateModal = ({ show, onHide, template }) => {
  ...
  const validate = () => {
    if (!editedTemplate.template_content?.trim()) {
  ...
  return (
    ...
    >
      ...
      <Modal.Footer>
        {!editMode ? (
          <>
            <Button variant="danger" onClick={handleDeleteClick}>מחק</Button>
            <Button variant="primary" onClick={handleEditClick}>ערוך</Button>
            <Button variant="secondary" onClick={() => handleCancelEdit(true)}>סגור</Button>
          </>
        ) : (
          <>
            ...
            <Button variant="outline-secondary" onClick={handleCancelEdit}>ביטול</Button>
          </>
        )}
      </Modal.Footer>
    </Modal>
